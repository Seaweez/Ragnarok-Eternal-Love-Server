    ...
    case USERPARAM_GMCOMMAND:
      {
		...
		if ((BaseConfig::getMe().getBranch() == BRANCH_DEBUG && CommonConfig::isInTFGMWhiteList(this->accid) == true) || (BaseConfig::getMe().getBranch() == BRANCH_TF && CommonConfig::isInTFGMWhiteList(this->accid) == true))
        {
