...
# Compile specified branch code, the parameter can be master, studio, tf, or release.
# If the parameter is empty, compile all four branches and upload the compiled executable files to the SVN directory.
